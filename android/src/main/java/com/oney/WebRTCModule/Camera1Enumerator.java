...
//This is the Enumerator for MyCameraCapturer e MyCameraSession for the Cam 1 API
...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    //MINE
    @Override
    public MyCameraCapturer createCapturer(String deviceName, CameraVideoCapturer.CameraEventsHandler eventsHandler) {
        return new MyCameraCapturer(deviceName, eventsHandler, captureToTexture);
    }
